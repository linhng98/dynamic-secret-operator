...
func (in *PlaintextSpec) DeepCopyInto(out *PlaintextSpec) {
	*out = *in
	if in.Secrets != nil {
		...
		*out = make([]*PLaintextSecretSpec, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(PLaintextSecretSpec)
...
func (in *PlaintextStatus) DeepCopyInto(out *PlaintextStatus) {
	*out = *in
	in.LastSyncedDate.DeepCopyInto(&out.LastSyncedDate)
}
